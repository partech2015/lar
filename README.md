...
| **2** | **[`11_reward_code_agent.py`](examples/basic/11_reward_code_agent.py)** | Code-First Agent Logic |
| **3** | **[`12_support_helper_agent.py`](examples/basic/12_support_helper_agent.py)** | Lightweight Tool Assistant |
| **4** | **[`19_fastapi_server.py`](examples/basic/19_fastapi_server.py)** | FastAPI Wrapper (Deploy Anywhere) |

#### 2. Core Patterns (`examples/patterns/`)
| # | Pattern | Concept |
| :---: | :--- | :--- |
| **1** | **[`2_rag_researcher.py`](examples/patterns/2_rag_researcher.py)** | RAG (ToolNode) & State Merging |
| **2** | **[`3_self_correction.py`](examples/patterns/3_self_correction.py)** | "Judge" Pattern & Error Loops |
| **3** | **[`5_parallel_execution.py`](examples/patterns/5_parallel_execution.py)** | Fan-Out / Fan-In Aggregation |
| **4** | **[`6_structured_output.py`](examples/patterns/6_structured_output.py)** | Strict JSON Enforcement |
| **5** | **[`7_multi_agent_handoff.py`](examples/patterns/7_multi_agent_handoff.py)** | Multi-Agent Collaboration |
| **6** | **[`8_meta_prompt_optimizer.py`](examples/patterns/8_meta_prompt_optimizer.py)** | Self-Modifying Agents (Meta-Reasoning) |
| **7** | **[`16_integration_test.py`](examples/patterns/16_integration_test.py)** | Integration Builder (CoinCap) |
| **8** | **[`17_ab_tester.py`](examples/patterns/17_ab_tester.py)** | A/B Tester (Parallel Prompts) |
| **9** | **[`18_resumable_graph.py`](examples/patterns/18_resumable_graph.py)** | Time Traveller (Crash & Resume) |

#### 3. Compliance & Safety (`examples/compliance/`)
| # | Pattern | Concept |
| :---: | :--- | :--- |
| **1** | **[`4_human_in_the_loop.py`](examples/compliance/4_human_in_the_loop.py)** | User Approval & Interrupts |
| **2** | **[`10_security_firewall.py`](examples/compliance/10_security_firewall.py)** | Blocking Jailbreaks with Code |
| **3** | **[`20_juried_layer.py`](examples/compliance/20_juried_layer.py)** | Proposer -> Jury -> Kernel |
| **4** | **[`21_access_control_agent.py`](examples/compliance/21_access_control_agent.py)** | **Flagship Access Control** |
| **5** | **[`22_context_contamination_test.py`](examples/compliance/22_context_contamination_test.py)** | Red Teaming: Social Engineering |
| **6** | **[`23_zombie_action_test.py`](examples/compliance/23_zombie_action_test.py)** | Red Teaming: Stale Authority |
| **7** | **[`24_hitl_agent.py`](examples/compliance/24_hitl_agent.py)** | Article 14 Compliance Node |

#### 4. High Scale (`examples/scale/`)
| # | Pattern | Concept |
| :---: | :--- | :--- |
| **1** | **[`9_corporate_swarm.py`](examples/scale/9_corporate_swarm.py)** | **Stress Test**: 60+ Node Graph |
| **2** | **[`13_mini_swarm_pruner.py`](examples/scale/13_mini_swarm_pruner.py)** | Dynamic Graph Pruning |
| **3** | **[`14_parallel_newsroom.py`](examples/scale/14_parallel_newsroom.py)** | True Parallelism (`BatchNode`) |
| **4** | **[`15_parallel_corporate_swarm.py`](examples/scale/15_parallel_corporate_swarm.py)** | Concurrent Branch Execution |
...
| # | Pattern | Concept |
| :---: | :--- | :--- |
| **1** | **[`25_dynamic_depth.py`](examples/metacognition/25_dynamic_depth.py)** | **Adaptive Complexity** (1 Node vs N Nodes) |
| **2** | **[`26_tool_inventor.py`](examples/metacognition/26_tool_inventor.py)** | **Self-Coding** (Writing Tools at Runtime) |
| **3** | **[`27_self_healing.py`](examples/metacognition/27_self_healing.py)** | **Error Recovery** (Injecting Fix Subgraphs) |
| **4** | **[`28_adaptive_deep_dive.py`](examples/metacognition/28_adaptive_deep_dive.py)** | **Recursive Research** (Spawning Sub-Agents) |
| **5** | **[`29_expert_summoner.py`](examples/metacognition/29_expert_summoner.py)** | **Dynamic Persona Instantiation** |
