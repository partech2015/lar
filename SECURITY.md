...
- We will work with the reporter to confirm the vulnerability and develop a fix.

- Once a fix is available, we will release a security patch and publicly disclose the vulnerability, crediting the reporter (if they wish to be named).
