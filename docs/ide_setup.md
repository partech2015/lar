...
2.  **Use The Template**: Fill out `@lar/IDE_PROMPT_TEMPLATE.md` with your agent's requirements.

**Why?**
Referencing the file ensures the AI uses the latest, official coding standards without you needing to copy-paste giant prompts.
