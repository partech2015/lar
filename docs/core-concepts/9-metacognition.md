...
*Using `examples/metacognition/25_dynamic_depth.py`*
...
*Using `examples/metacognition/26_tool_inventor.py`*
...
*Using `examples/metacognition/27_self_healing.py`*
...
*Using `examples/metacognition/28_adaptive_deep_dive.py`*
...
*Using `examples/metacognition/29_expert_summoner.py`*
